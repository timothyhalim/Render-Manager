...
path = [
    os.path.join(scriptFolder, '..','..', 'python', 'python3', 'shiboken2'),
    os.path.join(scriptFolder, '..','..', 'python', 'python3', 'PySide2'),
]
...
class UserInterface(QDialog):
    ...
    def setup_job_ui_list(self):
        ...
        column_number = 0
        for name, column_width in (("ID", 105), ("Date", 80),  ("Submitter", 90), ("File", 200), ("Layer", 80), ("Weight", 80),  ("Progress", 200), ("ETA", 80), ("Action", 80)):
